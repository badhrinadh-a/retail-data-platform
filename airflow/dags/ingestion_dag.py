...
with DAG(
    ...
    submit_spark_job = BashOperator(
        ...
        spark-submit \
            ...
            --packages io.delta:delta-core_2.12:4.2.0,org.apache.hadoop:hadoop-aws:3.3.4,com.amazonaws:aws-java-sdk-bundle:1.12.262,org.apache.spark:spark-sql-kafka-0-10_2.12:4.1.1 \
